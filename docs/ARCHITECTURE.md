...
## 🔐 Escrow & Payout (HTS + Scheduled Transactions)
1.  **Escrow**: When a bounty is picked, the Requester creates a **Scheduled Transaction** that locks the reward amount.
